...
let addMarkerMode = false; // Track whether "Add Marker Mode" is enabled
...
//map clicking
let selectedLatLng = null; // Store selected location
...
document.getElementById('search-form').addEventListener('submit', async (e) => {
    ...
    try {
        ...
        setTimeout(() => map.removeLayer(searchMarker), 5000); // 5 seconds
    } catch (error) {
